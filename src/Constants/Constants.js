...
export const watchList = [{ value: 'My Stocks', label: 'My Stocks' , data:[
    {
      id: 1,
      symbol: "AAPL",
  ...
  ]}, { value: 'Indices', label: 'Indices' }, { value: 'Stocks', label: 'Stocks' }, { value: 'Top 10 Gain NASDAQ', label: 'Top 10 Gain NASDAQ' }, { value: 'Top 10 Gain NySE', label: 'Top 10 Gain NySE' }, { value: 'Top 10 Loss NASDAQ', label: 'Top 10 Loss NASDAQ' }, { value: 'Top 10 Loss NYSE', label: 'Top 10 Loss NYSE' },]
