...
const OpenChainRowPopUp = ({ popUpData, closeModel, RowPopUp }) => {
  const classes = new useStyles();
  const [modelOpen, setModelOpen] = useState(true);

  const { limitPrice } = popUpData.limitPrice;
  const [state, setState] = useState({
    stockSymbol: { title: popUpData.stockSymbol.title, year: "" },
    side: "",
    share: 100,
    orderType: "",
    limitPrice: popUpData.limitPrice,
    comment: "",
    stockTrade: false,
    duration: "",
    extendedHours: "",
  ...
  return (
    <div>
      <Dialog
        open={RowPopUp}
        onClose={(closeModel, "backdropclick")}
        backdropClick={true}
        style={{ width: "100%" }}
      >
          ...
          <Grid container>
                  ...
                  >
                    <AutoCompleteInput
                      ...
                      handleChangeAutoComplete={
                        handleChangeAutoCompleteCondition
                      }
                    />
                  </FormControl>
                </Grid>
            ...
            {radioBtnValue == "oco" && (
              <React.Fragment>
                <Grid item sm={12}>
                  <h5>
                    If one order is executed, then the other order is
